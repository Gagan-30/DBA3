...
public class MiniProject {
    ...
    public static void insertIntoRoutesTableFromFile(Connection connection, String file)
        ...
        try (InputStream routes = MiniProject.class.getClassLoader().getResourceAsStream(file);
             PreparedStatement statement = connection.prepareStatement("INSERT INTO routes VALUES (?, ?, ?, ?, ?)");
             BufferedReader br =
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in);) {
            ...
            System.out.println("Please enter the host name of the database you want to connect to (localhost): ");
            ...
            System.out.println("Please enter the port number of the database you want to connect to (5432): ");
            String port = scanner.nextLine();
            if (port.isEmpty()) {
                port = "5432";
            }

            System.out.println("Please enter the name of the database you want to connect to (postgres): ");
